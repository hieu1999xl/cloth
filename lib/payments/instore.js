    ...
    try {
        ...
        indexOrders(req.app)
            .then(() => {
                ...
                req.session.message = 'Đơn hàng của bạn đang được tiếp nhận và trong quá trình xử lí. Dưới đây là thông tin đơn hàng';
        ...
        `;
                ...
                sendEmail(req.session.paymentEmailAddr, `Thông báo đặt hàng thành công từ Ogani`, getEmailTemplate(paymentResults));
